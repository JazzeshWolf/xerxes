...
_Generated_: 2026-09-19T22:20:37.000Z  
_Horizon_: 21 trading days, rebalanced every 21

## Verdict

**NOT VALIDATED.** UNVALIDATED -- neutralisation did not pass on every rebalance

| | |
|---|---|
| **ICIR** (the number that matters) | **0.378** |
| Bar it must clear | 0.300 |
| 12-1 momentum ICIR | 0.373 |
| Random-null ICIR | 0.156 |
| **Edge over the random null** | **0.222** |
| Mean IC | 0.039 |
| IC std | 0.104 |
| t-stat | 2.876 |
| Rebalances | 58 |
...
- neutralisation did not pass on every rebalance

## Against the benchmarks

| Arm | ICIR | Mean IC | t-stat | Gross spread / rebalance | Net of costs |
|---|---|---|---|---|---|
| **engine (under test)** | 0.378 | 0.039 | 2.876 | 1.10% | 0.98% |
| momentum_12_1 | 0.373 | 0.039 | 2.843 | 1.07% | 0.95% |
| reversal_5d | 0.051 | 0.004 | 0.389 | -0.10% | -0.46% |
| random | 0.156 | 0.010 | 1.185 | 0.24% | -0.14% |
...
- Mean turnover per rebalance: **28.44%**
- Cost drag per rebalance: **0.12%**
- Gross annualised: **13.18%**
- Net annualised (impact 20.0 bps): **11.74%**
...
|---|---|---|---|
| 10.0 | 32.22 | 1.01% | 12.08% |
| 20.0 | 42.22 | 0.98% | 11.74% |
| 30.0 | 52.22 | 0.95% | 11.39% |
...
Neutralisation FAILED on 2/58 rebalances -- the ranking is still partly beta or sector, and should not be treated as stock selection.
...
- Oldest bar: **2020-09-21**
- Newest bar: **2026-09-18**
- Trading days: **1488** (~5.95 years, requested 6)
